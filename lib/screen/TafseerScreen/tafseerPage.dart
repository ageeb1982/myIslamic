...
class TafseerPageState extends State<TafseerPage> 
{
...
PageController _controller = new PageController();
  ...
  void _goToElement()
  {
    // _controller.animateTo((100.0 * selectItemPos), // 100 is the height of container and index of 6th element is 5
        ...
        PageView.builder(
         ...
         physics: BouncingScrollPhysics(),
           ...
           itemBuilder: (_, int position) {
            ...
            final isSelect=ayahX.ayah==item.ayah&&ayahX.sura==item.sura;
            if(isSelect){selectItemPos=position;}
              return
     ...
     child:
      Column(children: <Widget>[
        ...
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[ 
              Text(item.suraName +"=> صفحة " + item.page.toString()+" ( "+  (snapshot.data.length).toString() +" / " + (position+1).toString() +" )",style: TextStyle(color: Colors.redAccent,fontWeight: FontWeight.bold), ),
              Divider(),
